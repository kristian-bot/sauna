...
export function StarRating({ rating, count, size = 'md', onRate }: StarRatingProps) {
    ...
    <div className="inline-flex items-center gap-1">
      <div className="flex">
        {[1, 2, 3, 4, 5].map((star) => (
          ...
          >
            <svg
              className={`${sizes[size]} ${star <= displayRating ? 'text-amber-400' : 'text-stone-200'} transition-colors`}
              fill="currentColor"
              viewBox="0 0 20 20"
            >
